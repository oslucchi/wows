    ...
    public static Indicator create(Spec spec) {
        ...
        try {
            ...
            if (p.length == 3 && pr != null) {
                try { return ctor(clazz, new Class[]{double.class,double.class,double.class,Price.class}, p[0],p[1],p[2],pr); } catch (NoSuchMethodException ignored) {}
            }
            // (int,int,int,Price)
            if (p.length == 3 && pr != null) {
                try { return ctor(clazz, new Class[]{int.class,int.class,int.class,Price.class}, (int)p[0],(int)p[1],(int)p[2],pr); } catch (NoSuchMethodException ignored) {}
            }

            // (double,double,Price)
            if (p.length == 2 && pr != null) {
                try { return ctor(clazz, new Class[]{double.class,double.class,Price.class}, p[0],p[1],pr); } catch (NoSuchMethodException ignored) {}
            }
            // (int,int,Price)
            if (p.length == 2 && pr != null) {
                try { return ctor(clazz, new Class[]{int.class,int.class,Price.class}, (int)p[0],(int)p[1],pr); } catch (NoSuchMethodException ignored) {}
            }

            // (double,Price)
            if (p.length == 1 && pr != null) {
                try { return ctor(clazz, new Class[]{double.class,Price.class}, p[0],pr); } catch (NoSuchMethodException ignored) {}
            }
            // (int,Price)
            if (p.length == 1 && pr != null) {
                try { return ctor(clazz, new Class[]{int.class,Price.class}, (int)p[0],pr); } catch (NoSuchMethodException ignored) {}
            }

            // (double)
            if (p.length == 1) {
                try { return ctor(clazz, new Class[]{double.class}, p[0]); } catch (NoSuchMethodException ignored) {}
            }
            // (int)
            if (p.length == 1) {
                try { return ctor(clazz, new Class[]{int.class}, (int)p[0]); } catch (NoSuchMethodException ignored) {}
            }
            ...
            StringBuilder sb = new StringBuilder("No matching constructor for ").append(fqcn).append("\nAvailable:\n");
            for (Constructor<?> c : clazz.getConstructors()) sb.append("  ").append(c).append('\n');
